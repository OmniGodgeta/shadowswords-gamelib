...
self.addEventListener("fetch", (e) => {
  ...
  if (/^\/(roms|music|gamevideo|states|netplay|thumb|jellyfin|play|twitch|discord|search|request|auth|admin|banner|u|watch)(\/|$|\?)/.test(u.pathname)) return;
