...
self.addEventListener("fetch", (e) => {
  ...
  if (/^\/(roms|music|gamevideo|states|netplay|thumb|jellyfin|play|twitch|discord|search|request|auth|admin|banner|u|watch|chat|socket\.io|list|np|iptv)(\/|$|\?)/.test(u.pathname)) return;
